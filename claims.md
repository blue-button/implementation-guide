...
There is a workgroup actively working on describing how medical claims data should be structured. If this is an area that is relevant to you or your organization, participate in the [ABBI Workgroup for Payer Content](http://wiki.siframework.org/ABBI+Payers+Workgroup).
